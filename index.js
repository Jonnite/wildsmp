...
new Session({
	hostName: "Wild SMP", // The hostname of the server
	worldName: "Wild SMP", // Use as a MOTD
	version: "1.20.x", // The version of the session, this can be any string.
	...
	ip: "play.wildsmp.xyz", // The ip of the server you are using.
	port: 25590, // The port of the server you are using.
	...
	accounts: ["wilsonjonty4@gmail.com"], // A list of emails that correspond to accounts you want to use with FriendConnect.
